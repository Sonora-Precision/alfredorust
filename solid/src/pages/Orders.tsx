                  ...
                  return (
                    <div class="rounded-lg border border-border p-3">
                      <div class="flex items-start justify-between gap-2">
                        <p class="min-w-0 flex-1 font-medium text-foreground">{o.title}</p>
                        <Show when={isAdmin()}>
                      ...
                      <div class="mt-2 flex flex-wrap items-center gap-2 text-xs">
                        <Badge tone={statusBadgeTone(label)}>{label}</Badge>
                        <span class="font-medium text-foreground tnum">{money(o.amount)}</span>
                        <Show when={contactName(o.contact_id)}>
                          <span class="text-muted-foreground">{contactName(o.contact_id)}</span>
                        </Show>
                        <Show when={o.scheduled_at}>
                          <span class="text-muted-foreground tnum">{rfc3339ToDate(o.scheduled_at!)}</span>
                        </Show>
                      </div>
                    </div>
                  )
