  ...
  return (
    <Show when={isDemo()}>
      <div
        ...
        class="demo-banner relative z-20 flex flex-wrap items-center justify-center gap-x-2 gap-y-1 border-b border-border bg-primary/10 px-4 py-1.5 text-center text-[12px] backdrop-blur"
      >
