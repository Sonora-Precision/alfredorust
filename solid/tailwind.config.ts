...
// Ported verbatim from frontend/tailwind.config.js — same semantic color
// names, same CSS-variable indirection so Tailwind alpha modifiers
// (`bg-primary/90`, `ring-emerald-500/30`, …) keep working.
export default {
